...
export function PromptPreview() {
  ...
  <pre className="text-sm text-[var(--text)] whitespace-pre-wrap mb-3 max-h-[50vh] overflow-auto">{text}</pre>
      ...
      {copied && (
        <div role="status" aria-live="polite" className="mb-3 text-xs text-green-600 dark:text-green-300">Copied to clipboard</div>
      )}
